...
\textbf{Positivity Constraint}: To guarantee valid probability densities, we enforce $u(t,x) \ge 0$ by applying a \textbf{Softplus} activation ($\ln(1+e^x)$) to the final output layer.
